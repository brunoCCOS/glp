...
\title{A compositional and diagrammatic syntax for parametric linear programming}
\subtitulo{}
\cidade{Rio de Janeiro}
\date{2026}
\orientador{João Paixão}
\coorientador{Iago Leal}
\orientadorestitulo{D.Sc.}
\textofolharosto{Dissertação de Mestrado apresentada ao \@nomeprograma,
  \@nomeinstituto\ e \@nomeinstitutoparceiro, \@nomeuniversidade, como
  requisito parcial à obtenção do título de Mestre em Informática.}
