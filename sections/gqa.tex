...
\section{Preliminary results about quadratic functions}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% GQA ALGEBRA %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Graphical Algebra for quadratic problems}\label{sec:gqa}
...
is the conceptual foundation in our theory of Linear Programming developed in Chapter~\ref{sec:glp}.
