\begin{center}
    \begin{tikzpicture}[axpic]
      ...
      \pic[val=S] (m1) at (2.000,0.500) {comatrix};
    ...
    \begin{tikzpicture}[axpic]
      ...
      \pic (c1) at (3.500,2.500) {comultiplication};
      \pic (c2) at (3.500,0.500) {comultiplication};
      \pic[val=s_{1,1}] (s11) at (4.750,3.000) {coscalar};
      \pic[val=s_{1,2}] (s12) at (4.750,2.000) {coscalar};
      \pic[val=s_{2,1}] (s21) at (4.750,1.000) {coscalar};
      \pic[val=s_{2,2}] (s22) at (4.750,0.000) {coscalar};
      \pic (k1) at (7.250,2.500) {cocopy};
      \pic (k2) at (7.250,0.500) {cocopy};
    ...
    \begin{tikzpicture}[axpic]
      ...
      \pic (c2) at (3.500,0.500) {comultiplication};
      \pic[val=s_{1,1}] (s11) at (4.750,3.000) {coscalar};
      \pic[val=s_{2,1}] (s21) at (4.750,2.000) {coscalar};
      \pic[val=s_{1,2}] (s12) at (4.750,1.000) {coscalar};
      \pic[val=s_{2,2}] (s22) at (4.750,0.000) {coscalar};
      \pic (k1) at (6.000,2.500) {cocopy};
      \pic (k2) at (6.000,0.500) {cocopy};
      \draw (l1-out-0) to[out=0,in=180] (c0-in-0);
      \draw (c0-out-0) to[out=0,in=180] (c1-in-0);
      \draw (c0-out-1) to[out=0,in=180] (c2-in-0);
      \draw (c1-out-0) to[out=0,in=180] (s11-in-0);
