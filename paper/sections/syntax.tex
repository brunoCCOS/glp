...
\begin{example}[ReLU activation]
  ...
  \begin{center}
    \vspace{1.5em}
    \textit{[Diagram: ReLU as a $\mathbf{GLP}$ diagram]}
    \vspace{1em}
  \end{center}
\end{example}
...
\begin{example}[Feedforward networks with ReLU activations]
  ...
  \begin{center}
    \vspace{1.5em}
    \textit{[Diagram: one-hidden-layer ReLU network as a $\mathbf{GLP}$ diagram]}
    \vspace{1em}
  \end{center}
\end{example}
...
\begin{example}[Max-pooling]
  ...
  \begin{center}
    \vspace{1.5em}
    \textit{[Diagram: max-pooling as a $\mathbf{GLP}$ diagram]}
    \vspace{1em}
  \end{center}
\end{example}
...
\begin{example}[$\ell_1$ regularisation]
  ...
  \begin{center}
    \vspace{1.5em}
    \textit{[Diagram: $\ell_1$ norm as a $\mathbf{GLP}$ diagram]}
    \vspace{1em}
  \end{center}
\end{example}
