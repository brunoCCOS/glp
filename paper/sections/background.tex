...
This is equivalent to demanding that our theory is sound, complete and expressable. Those three properties capture the idea that the semmantics is fully capable of express and prove the same facts that the semmantics is. Moreover, these properties denote equivalent characteristics about the interpretation map, both categorically and functionally, as depicted in Table~\ref{tab:equivalences}.
