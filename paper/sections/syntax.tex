...
linear objective function $c^\top x$. As we will se more clearer later, this
new generator plays a similar row to that of a ´´measurement´´ such that is simply exposing
...
\begin{proof}
	...
	\begin{itemize}
        \item The generator $\begin{tikzpicture} \pic (g1) at (0.500,0.500) {linear}; \end{tikzpicture}$
		      \begin{figure}[H]
			      \centering
			      \input{tikz/ProofNormalForm1.tex}
		      \end{figure}
          \item A diagram $c \in \textbf{GPA}$ is a polyhedral, which by normal form \cite{bonchi2021polyhedral} is just $\{|Ax + a \ge By |\}$, thus:
		      \begin{figure}[H]
			      \centering
			      \input{tikz/ProofNormalForm2.tex}
		      \end{figure}
	\end{itemize}
	...
	\begin{figure}[H]
		\centering
		\input{tikz/ProofNormalForm3.tex}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\input{tikz/ProofNormalForm4.tex}
	\end{figure}
\end{proof}
