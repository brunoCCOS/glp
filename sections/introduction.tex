...
Notice that here $a\le_Q b \iff a\ge b$, so this replacement recovers exactly the same expression as above.
...
Graphical languages therefore are remarkably well suited to the use case in evidence.
...
\textit{but the system's main properties are the syntax operations themselves}.
